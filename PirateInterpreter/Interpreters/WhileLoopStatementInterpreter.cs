...
public class WhileLoopStatementInterpreter : BaseInterpreter
{
    ...
    public override List<BaseValue> VisitNode()
    {
        ...
        var interpreter = _interpreterFactory.GetInterpreter(whileLoopStatementNode.ConditionNode, Logger);
        ...
        while (conditionBoolean)
        {
            ...
            var newConditionValueNode = _interpreterFactory.GetInterpreter(whileLoopStatementNode.ConditionNode, Logger).VisitSingleNode();
